...
const NavBar = () => {
  ...
  return (
    <>
      <nav className="container mx-auto flex items-center justify-between py-4 px-6">
        <div>
          <Link to="/" className="text-2xl font-medium flex">
            <img src="./Zubee-E-Comm.png" alt="" className="h-15 w-20 " />
          </Link>
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          >
            ...
            {cartItemCount > 0 && (
              <span className="absolute -top-1 bg-Zubee-red text-white text-xs rounded-full px-2 py-0.5">
                {cartItemCount}
              </span>
            )}
          </button>
      ...
      <div
        className={` fixed top-0 left-0 w-3/4 sm:w-1/2 md:w-1/3 h-full bg-white shadow-lg transform translate-transform duration-300 z-50 ${
